...
from nutritionist.repositories.meal_entry import MealEntryRepository
...
class ReportTool(BaseTool):
    ...
    def _run(self, telegram_id: str, report_date: Optional[str] = None) -> str:
        try:
            ...
            return f"Relatório gerado com sucesso para o usuário {user.name}.\nConteúdo do relatório:\n{report_content}"
